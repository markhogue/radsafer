...
vignette: >
  %\VignetteIndexEntry{Introduction to radsafer}
...
```{r out.width = '75%', fig.align='center', warning=FALSE, message=FALSE, echo = TRUE}
...
In some photon plots, very low energy X-rays dominate the chart. To avoid this, you can use the E_min parameter. Below are two examples, one with and one without the low energy cutoff.
